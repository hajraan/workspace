...
public abstract class StackTest {
    ...
    /*
     * To be thorough and systematic NONE, ONE, AND SOME
     */

    /*
     * Hajraan Hussains Test cases This is to thouroughly test push, and length
     * Stack Kernel methods
     */
    @Test
    public final void testPushLength() {
    ...
    /*
     * Hajraan Hussains Test cases This is to thouroughly test pop, and length
     * Stack Kernel methods
     */
    @Test
    public final void testPopLength() {
        Stack<String> s = this.createFromArgsTest("you", "are", "cool");
        Stack<String> sExpected = this.createFromArgsRef("you", "are", "cool");
        assertEquals(sExpected, s);
        assertEquals(sExpected.length(), s.length());
