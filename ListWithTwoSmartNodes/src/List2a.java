 ...
 * [$this.postFinish points to the last node of a singly linked list
 ...
 *    $this.lastLeft],
 *   [data in nodes starting at $this.lastLeft.next and running up to
 *   $this.postFinish])
 * </pre>
 */
public class List2a<T> extends ListSecondary<T> {
    ...
    public final void moveToFinish() {
        ...
        Node current = this.preStart;

        while (it.hasNext()) {
            T x = it.next();
            current = current.next;
        }
        this.lastLeft = current;
