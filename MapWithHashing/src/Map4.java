...
/**
 * بسم الله الرحمن الرحيم {@code Map} represented as a hash table using
 * {@code Map}s for the buckets, with implementations of primary methods.
 *
 * @param <K>
...
public class Map4<K, V> extends MapSecondary<K, V> {
    ...
    public final Pair<K, V> removeAny() {
        ...
        //decrease size
        this.size--;
        return this.hashTable[count].removeAny();
