 ...
 *
 * @author Wayne Heym
 * @author Hajraan Hussain && Oybek Kamalov
 *
 */
public abstract class StatementTest {
    ...
    /**
     * Test2 kind of a WHILE statement.
     */
    @Test
    public final void test2KindWhile() {
        /*
         * Setup
         */
    ...
    /**
     * Test2 addToBlock at an interior position.
     */
    @Test
    public final void test2AddToBlockInterior() {
        /*
         * Setup
         */
     ...
     */
    @Test
    public final void test2RemoveFromBlockFrontLeavingNonEmpty() {
        /*
         * Setup
         */
        Statement sTest = this.createFromFileTest(FILE_NAME_2);
    ...
    /**
     * Test2 lengthOfBlock, greater than zero.
     */
    @Test
    public final void test2LengthOfBlockNonEmpty() {
        /*
         * Setup
         */
        Statement sTest = this.createFromFileTest(FILE_NAME_2);
     ...
     */
    @Test
    public final void test2AssembleIf() {
        /*
         * Setup
         */
     ...
     */
    @Test
    public final void test2DisassembleIf() {
        /*
         * Setup
         */
        Statement blockTest = this.createFromFileTest(FILE_NAME_2);
    ...
    /**
     * Test2 assembleIfElse.
     */
    @Test
    public final void test2AssembleIfElse() {
        /*
         * Setup
         */
        final int ifElsePos = 2;
     ...
     */
    @Test
    public final void test2DisassembleIfElse() {
        /*
         * Setup
         */
        final int ifElsePos = 2;
     ...
     */
    @Test
    public final void test2AssembleWhile() {
        /*
         * Setup
         */
        Statement blockTest = this.createFromFileTest(FILE_NAME_2);
    ...
    /**
     * Test2 disassembleWhile.
     */
    @Test
    public final void test2DisassembleWhile() {
        /*
         * Setup
         */
        final int whilePos = 0;
    ...
    /**
     * Test2 disassembleCall.
     */
    @Test
    public final void test2DisassembleCall() {
        /*
         * Setup
         */
        Statement blockTest = this.createFromFileTest(FILE_NAME_2);
