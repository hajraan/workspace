...
public abstract class ProgramTest {
    ...
    private static final String FILE_TRY_TO_GUESS = "data/program-TryToGuess.bl";
    ...
    /**
     * Test TryToGuess name.
     */
    @Test
    public final void testTryToGuessName() {
        /*
         * Setup
         */
        Program pTest = this.createFromFileTest(FILE_TRY_TO_GUESS);
        Program pRef = this.createFromFileRef(FILE_TRY_TO_GUESS);
         ...
         */
        assertEquals(pRef, pTest);
        assertEquals("TryToGuess", result);
    }

    /**
     * Test TryToGuess setName.
     */
    @Test
    public final void testTryToGuessSetName() {
        /*
         * Setup
         */
        Program pTest = this.createFromFileTest(FILE_TRY_TO_GUESS);
    ...
    /**
     * Test TryToGuess newContext.
     */
    @Test
    public final void testTryToGuessNewContext() {
        /*
         * Setup
         */
        Program pTest = this.createFromFileTest(FILE_TRY_TO_GUESS);
    ...
    /**
     * Test TryToGuess swapContext.
     */
    @Test
    public final void testTryToGuessSwapContext() {
        /*
         * Setup
         */
        Program pTest = this.createFromFileTest(FILE_TRY_TO_GUESS);
    ...
    /**
     * Test TryToGuess newBody.
     */
    @Test
    public final void testTryToGuessNewBody() {
        /*
         * Setup
         */
        Program pTest = this.createFromFileTest(FILE_TRY_TO_GUESS);
    ...
    /**
     * Test TryToGuess swapBody.
     */
    @Test
    public final void testTryToGuessSwapBody() {
        /*
         * Setup
         */
        Program pTest = this.createFromFileTest(FILE_TRY_TO_GUESS);
